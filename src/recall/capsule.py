...
:mod:`recall.store`) and later feed the same canonical :class:`~recall.schema.Event`
...
mirroring :mod:`recall.schema`, so they round-trip cleanly through JSON and the
SQLite store.
"""
