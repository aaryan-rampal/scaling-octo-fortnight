...
The Claude adapter emits the canonical :class:`~core.schema.Event` (not a
separate ChatEvent type) and persists through ``storage.persist.persist_events``
into the single events table, exactly like iMessage and Spotify.
"""

from __future__ import annotations

from adapters.llm_chats import to_chat_events
